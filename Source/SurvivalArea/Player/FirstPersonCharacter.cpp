...
void AFirstPersonCharacter::BeginPlay()
{
	...
	GunToHold = GWorld->SpawnActor<AGun>(GunClass);
	//gun->AttachToComponent(Mesh1P, FAttachmentTransformRules::SnapToTargetIncludingScale, FName(TEXT("GripPoint")));
	GunToHold->AttachToComponent(Mesh1P, FAttachmentTransformRules(EAttachmentRule::SnapToTarget, true), FName(TEXT("GripPoint")));
	//UE_LOG(LogTemp, Warning, TEXT("Children: %d"), Mesh1P->GetAttachChildren().Num());
...
void AFirstPersonCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	...
	{
		//TODO AFirstPersonCharacter::EndTouch To Remove
		//OnFire();
	}
